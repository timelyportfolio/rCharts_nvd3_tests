...
p13$templates$script = system.file("/libraries/nvd3/layouts/nvd3FacetPlot.html", 
    package = "rCharts")
p13$show("iframe", cdn = F)
```
...
p14$templates$script = system.file("/libraries/nvd3/layouts/nvd3FacetPlot.html", 
    package = "rCharts")
# p14$chart(color = c('brown', 'blue', '#594c26', 'green'))
p14$show("iframe", cdn = F)
```
